...
class AdventuresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create adventure" do
    assert_difference('Adventure.count') do
      post adventures_url, params: { adventure: { description: @adventure.description, name: @adventure.name, picture: @adventure.picture, visit: @adventure.visit } }
    end
  ...
  test "should update adventure" do
    patch adventure_url(@adventure), params: { adventure: { description: @adventure.description, name: @adventure.name, picture: @adventure.picture, visit: @adventure.visit } }
